...
export default function TasksPage() {
  ...
  }, [page, statusFilter, priorityFilter, searchFilter, sortFilter]);
    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mt-6 flex flex-wrap items-end gap-4 rounded-lg border border-[var(--border)] bg-[var(--card)] p-4">
        ...
        <div className="flex min-w-0 flex-1 flex-col gap-1">
          ...
          <input id="task-search" type="text" value={searchFilter} onChange={(e) => resetPage(setSearchFilter, e.target.value)} placeholder="Search tasks..." className="rounded-md border border-[var(--border)] bg-[var(--background)] px-3 py-2 text-sm text-[var(--foreground)] placeholder:text-[var(--muted-foreground)] focus:outline-none focus:ring-2 focus:ring-[var(--primary)]" />
        </div>
        <div className="flex flex-col gap-1">
